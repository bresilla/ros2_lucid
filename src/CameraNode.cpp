...
#include <ros2_lucid/srv/trigger_capture.hpp>
...
void CameraNode::init_params() {
    ...
    captrig = this->create_client<ros2_lucid::srv::TriggerCapture>("captrig");
}
...
void CameraNode::config_node(bool managed = false) {
    ...
    service = this->create_service<ros2_lucid::srv::TriggerCamera>(
...
void CameraNode::load_settings_from_file() {
    auto config_dir = ament_index_cpp::get_package_share_directory("ros2_lucid") + "/config/";
...
sensor_msgs::msg::Image::SharedPtr CameraNode::get_image(int trigger_type) {
    ...
    auto request = std::make_shared<ros2_lucid::srv::TriggerCapture::Request>();
    request->mac_address = mac;
    auto result = captrig->async_send_request(request, [](rclcpp::Client<ros2_lucid::srv::TriggerCapture>::SharedFuture future) {
...
const std::shared_ptr<ros2_lucid::srv::TriggerCamera::Request> request, 
std::shared_ptr<ros2_lucid::srv::TriggerCamera::Response> response) {
